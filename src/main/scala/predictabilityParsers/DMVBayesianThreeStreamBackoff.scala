    ...
    // 
    //     val grammarInit =
    //       if(opts.has( "grammarInit" )) opts.valueOf( "grammarInit" ).toString else "additiveHarmonic"
    // 
    //     val rightFirst =
    ...
    // 
    //     val initialGrammar =
    //       if( grammarInit == "additiveHarmonic" ) {
    //         print( "Initializing additive harmonic grammar..." )
    //         estimator.setAdditiveHarmonicGrammar(
    //           trainSet,
    ...
    //         )
    //       } else if ( grammarInit == "multiplicativeHarmonic" ) {
    //         print( "Initializing multiplicative harmonic grammar..." )
    //         estimator.setMultiplicativeHarmonicGrammar(
    //           trainSet,
    //           rightFirst = rightFirst,
    //           cAttach = cAttach,
    //           cStop = cStop,
